...
public class StumpedTreePrior extends SpeciesTreeDistribution implements StubExpectation {
	...
	final public Input<RealParameter> netDivInput = new Input<>("netDiv", "net diversification rate", Input.Validate.XOR, lambdaInput);
	...
	public void initAndValidate() {
		...
		if (netDivInput.get() != null && turnoverInput.get() == null) {
			System.err.println("Turnover must be specified when diversification rate is used!");
			System.exit(1);
		}
	...
	public double getLambda(){
		return lambdaInput.get() != null ? lambdaInput.get().getValue() : netDivInput.get().getValue()/(1-turnoverInput.get().getValue());
	}
